...
import uk.nhs.nhsdigital.fhirvalidatorSTU3.shared.PrePopulatedValidationSupport
...
@Service
class ImplementationGuideParser(@Qualifier("STU3") private val fhirContext: FhirContext) {
