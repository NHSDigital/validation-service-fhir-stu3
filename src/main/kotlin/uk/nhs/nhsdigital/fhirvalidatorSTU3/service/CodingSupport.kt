package uk.nhs.nhsdigital.fhirvalidatorSTU3.service
...
import uk.nhs.nhsdigital.fhirvalidatorSTU3.configuration.TerminologyValidationProperties
...
@Service
class CodingSupport(@Qualifier("STU3") private val ctx: FhirContext?,
