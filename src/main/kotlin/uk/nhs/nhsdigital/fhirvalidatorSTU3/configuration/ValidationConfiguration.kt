...
import uk.nhs.nhsdigital.fhirvalidatorSTU3.shared.NHSDCachingValidationSupport
import uk.nhs.nhsdigital.fhirvalidatorSTU3.shared.RemoteTerminologyServiceValidationSupport
import uk.nhs.nhsdigital.fhirvalidatorSTU3.util.AccessTokenInterceptor
import uk.nhs.nhsdigital.fhirvalidatorSTU3.validationSupport.SwitchedTerminologyServiceValidationSupport
import uk.nhs.nhsdigital.fhirvalidatorSTU3.validationSupport.UnsupportedCodeSystemWarningValidationSupport
...
open class ValidationConfiguration(
    ...
    @Bean
    open fun validator(@Qualifier("STU3") fhirContext: FhirContext, instanceValidator: FhirInstanceValidator): FhirValidator {
